  ...
  <Card
    className={cn(
      `w-72 flex flex-col justify-between py-1 ${
        popular ? "border-rose-400" : "dark:border-zinc-700 border-slate-300"
      } mx-auto sm:mx-0`,
      {
        "animate-background-shine bg-[linear-gradient(110deg,#f1f5f9,45%,#e2e8f0,55%,#f1f5f9)] dark:bg-[linear-gradient(110deg,#020617,45%,#1e293b,55%,#020617)] bg-[length:200%_100%] transition-colors":
          exclusive,
      }
    )}
  >
...
const CheckItem = ({ text }: { text: string }) => (
  <div className='flex gap-2'>
    <Check size={18} className='my-auto text-green-400' />
